...
- [开发工具](#开发工具)
  ...
  - [Chrome DevTools for Agents](docs/add-chrome-devtools-agents.md)
- [平台 / 服务](#平台--服务)
...
Chrome 官方发布 DevTools for Agents 1.0 —— MCP Server + CLI + Agent Skills，为 AI 编码工具提供实时浏览器调试能力。支持 Claude Code、Gemini CLI、Antigravity。

```
  AI 编码代理 ──▶ [Chrome DevTools for Agents v1.0]
                    ├── MCP Server  (工具协商/发现)
                    ├── CLI         (批量脚本/省 token)
                    └── Agent Skills (a11y/性能/内存泄漏)
                         │
                    ┌────▼────┐
                    │ Chrome 浏览器 │
...
| 📅 2026-05-19 | 🏢 Google Chrome | 🌐 MCP + CLI + Skills | 🔧 Claude/Gemini/Antigravity |
|---------------|------------------|----------------------|------------------------------|

[→ 原文](https://developer.chrome.com/blog/devtools-for-agents-v1?hl=zh-cn) · [→ 详细](docs/add-chrome-devtools-agents.md)
